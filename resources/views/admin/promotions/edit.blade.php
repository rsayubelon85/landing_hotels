                        ...
                        <form action="{{ route('admin.promotions.update', $promotion) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="mt-2">
                                        <i class="{{ old('icon', $promotion->icon) }} {{ old('icon_color', $promotion->icon_color) }} fa-3x"></i>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select
                                        ...
                                        required
                                    >
                                        <option value="text-primary" {{ old('icon_color', $promotion->icon_color) == 'text-primary' ? 'selected' : '' }}>Azul Primario</option>
                                        <option value="text-success" {{ old('icon_color', $promotion->icon_color) == 'text-success' ? 'selected' : '' }}>Verde</option>
                                        <option value="text-warning" {{ old('icon_color', $promotion->icon_color) == 'text-warning' ? 'selected' : '' }}>Amarillo/Anaranjado</option>
                                        <option value="text-danger" {{ old('icon_color', $promotion->icon_color) == 'text-danger' ? 'selected' : '' }}>Rojo</option>
                                        <option value="text-info" {{ old('icon_color', $promotion->icon_color) == 'text-info' ? 'selected' : '' }}>Cian</option>
                                        <option value="text-secondary" {{ old('icon_color', $promotion->icon_color) == 'text-secondary' ? 'selected' : '' }}>Gris</option>
                                    </select>
                                    @error('icon_color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select
                                        ...
                                        name="badge_color"
                                    >
                                        <option value="bg-primary" {{ old('badge_color', $promotion->badge_color) == 'bg-primary' ? 'selected' : '' }}>Azul Primario</option>
                                        <option value="bg-success" {{ old('badge_color', $promotion->badge_color) == 'bg-success' ? 'selected' : '' }}>Verde</option>
                                        <option value="bg-warning" {{ old('badge_color', $promotion->badge_color) == 'bg-warning' ? 'selected' : '' }}>Amarillo</option>
                                        <option value="bg-danger" {{ old('badge_color', $promotion->badge_color) == 'bg-danger' ? 'selected' : '' }}>Rojo</option>
                                        <option value="bg-info" {{ old('badge_color', $promotion->badge_color) == 'bg-info' ? 'selected' : '' }}>Cian</option>
                                        <option value="bg-secondary" {{ old('badge_color', $promotion->badge_color) == 'bg-secondary' ? 'selected' : '' }}>Gris</option>
                                    </select>
                                    @error('badge_color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select
                                        ...
                                        required
                                    >
                                        <option value="1" {{ old('is_active', $promotion->is_active) == 1 ? 'selected' : '' }}>Activa</option>
                                        <option value="0" {{ old('is_active', $promotion->is_active) == 0 ? 'selected' : '' }}>Inactiva</option>
                                    </select>
                                    @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
